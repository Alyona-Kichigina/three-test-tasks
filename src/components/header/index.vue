<template>
	<div class="header">
		...
		<div class="header-wrapper">
			<div class="icon-watch-menu hidden-lg">
				<transition name="slide-fade">
					<button class="header-btn" v-if="show" key="on" @click="show = false">
						<img src="../../../public/icon/watch-menu.svg" alt="">
					</button>
			...
			<div class="logo">
				<router-link to="/">
					<img src="../../../public/img/logo.png" alt="" class="hidden-md">
					<img src="../../../public/img/croppedLogo.png" alt="" class="hidden-lg">
				</router-link>
			</div>
			<transition name="dropdown">
				<Menu :class="{ 'active': show }"/>
			</transition>
			<router-link class="user" to="/form">
